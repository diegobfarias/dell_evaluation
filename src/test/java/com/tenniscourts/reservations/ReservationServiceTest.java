...
public class ReservationServiceTest {
    ...
    @Test
    public void givenAReservation_whenHoursBetweenNowAndScheduleIsGreaterOrEqual24HoursAndGetRefundValue_thenReturnReservationValueWithFees() {
    ...
    @Test
    public void givenAReservation_whenHoursBetweenNowAndScheduleIsGreaterOrEqual12HoursAndIsLessThan24HoursAndGetRefundValue_thenReturnReservationValueWithFees() {
        LocalDateTime testReferenceDate = LocalDate.of(2021, 07, 01).atStartOfDay();
    ...
    @Test
    public void givenAReservation_whenHoursBetweenNowAndScheduleIsGreaterOrEqual2HoursAndIsLessThan12HoursAndGetRefundValue_thenReturnReservationValueWithFees() {
        LocalDateTime testReferenceDate = LocalDate.of(2021, 07, 01).atStartOfDay();
    ...
    @Test
    public void givenAReservation_whenHoursBetweenNowAndScheduleIsGreaterOrEqual1MinuteAndIsLessThan2HoursAndGetRefundValue_thenReturnReservationValueWithFees() {
        LocalDateTime testReferenceDate = LocalDate.of(2021, 07, 01).atStartOfDay();
    ...
    @Test
    public void givenAReservation_whenHoursBetweenNowAndScheduleIsGreaterOrEqual0MinuteAndIsLessThan1MinuteAndGetRefundValue_thenReturnReservationValueWithFees() {
