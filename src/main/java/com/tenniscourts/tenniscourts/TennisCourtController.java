...
public class TennisCourtController extends BaseRestController {
    ...
    @PostMapping
    @ApiOperation(value = "API Operation that creates a tennis court.")
    @ApiResponses(value = {
        @ApiResponse(code = 201, message = "Tennis court succesfully created.")
    })
    ...
    @ApiOperation(value = "API operation that returns a tennis court by its ID.")
    @ApiResponses(value = {
        @ApiResponse(code = 200, message = "Tennis court succesfully found."),
    ...
    @ApiResponses(value = {
        ...
        @ApiResponse(code = 404, message = "Tennis court with schedules not found.")
    })
